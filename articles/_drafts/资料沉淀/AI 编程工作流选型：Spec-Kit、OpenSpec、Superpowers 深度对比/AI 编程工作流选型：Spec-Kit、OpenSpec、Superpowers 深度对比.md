...
> 原文链接：https://mp.weixin.qq.com/s/4V9LTNFmCQvuIvtQohNH1A
> 文章时间：2026年3月26日 20:30

## 重点内容与核心观点

文章对 Spec-Kit、OpenSpec、Superpowers 三类 AI 编程工作流进行选型比较。核心观点是：Spec-Kit 适合大型项目和多人协作，通过阶段门控追求规范可执行化；OpenSpec 适合快速迭代和现有项目改造，以轻量变更目录管理活文档；Superpowers 适合质量优先和强制 TDD 的团队，通过技能触发把流程约束嵌入 Agent 行为。选型关键不是 Star 数，而是团队更需要严格门控、灵活迭代还是技能化质量流程。
...
![AI 编程工作流选型对比](images/01-02-AI-编程工作流选型对比.png)AI 编程工作流选型对比
...
![架构对比](images/02-03-架构对比.png)架构对比

_图 2：三者的技术架构对比（技术栈、核心组件、数据流）_
...
![核心特性雷达图](images/03-04-核心特性雷达图.png)核心特性雷达图

_图 3：三者在易用性、工具支持、流程严格度等多维度的能力对比_
...
![工作流范式对比](images/04-05-工作流范式对比.png)工作流范式对比

_图 4：三种工作流范式对比（阶段门控式 vs 流畅迭代式 vs 技能触发式）_
...
![技术选型决策树](images/05-06-技术选型决策树.png)技术选型决策树

_图 5：根据项目场景快速选择合适的 AI 编程工作流工具_

...
文章围绕 Anthropic 的 Boris Cherny 对 Claude Code、Agentic Coding 和软件产业变化的判断展开。核心观点是：写代码正在从亲自实现转向管理多个 Agent，工程师的价值会更多体现在任务拆解、验证、产品判断和组织流程设计上；同时，AI 会削弱传统 SaaS 的切换成本和流程壁垒，但安全、治理、真实业务约束仍会决定这场变化的落地速度。
...
![Boris Cherny：Claude Code 之后，写代码正在变成“管理 Agent”](images/01-4cc5e7964b.png)
...
![从写代码到管理 Agent 的核心变化](images/03-f404fcbed6.png)
...
![Claude Code 的产品悬置与模型能力时间线](images/04-18a3885859.png)
...
![Boris 用手机和 Loop 调度几百个 Agent 的工作流](images/05-b5fd2be278.png)
...
![Claude Code 团队里跨角色写代码的通才化趋势](images/06-3631f58389.png)
...
![AI 可能抹平与仍然保留的 SaaS 护城河](images/07-6eca93e66f.png)
...
![从印刷术到软件大众化的类比](images/08-ee89551669.png)
...
![Anthropic 的领先来自组织流程改造](images/09-1c2a38d97e.png)
...
![Boris 预测接下来需要观察的三个信号](images/10-baca2a7d6b.png)

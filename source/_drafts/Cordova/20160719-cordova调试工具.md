...
![connected.png](http://ww3.sinaimg.in/large/006tNbRwgw1f6qxy2sqdvj30ib0avdgy.jpg)
...
1. 从windows开始菜单或Mac Finder打开GapDebug。
  ...
  ![ui-no-devices-v2.png](http://ww3.sinaimg.in/large/006tNbRwgw1f6qseuph4bj30jg09xab2.jpg)

  运行后，GapDebug在你的系统上会产生一个调起快捷菜单的图标，windows是状态栏右侧的托盘，Mac在上面的通知栏上。从Windows系统托盘打开的用户界面：

  ![openGapdebug.jpg](http://ww1.sinaimg.in/large/006tNbRwgw1f6qxwvnzyqj30re08w75w.jpg)

2. 使用USB数据线连接你的设备到你的工作站（workstation）。（USB线连接手机和你的电脑）

3. 允许你的工作站作为一个信任设备。最初你的设备连接你的工作站时，你可能收到提示工作站否是可信任的连接源。选择OK或Trust。

  ![android-ios-trust-50 (1).jpg](http://ww4.sinaimg.in/large/006tNbRwgw1f6qwl92p6nj30gq05674y.jpg)

  在设备界面的设备信息展示。

  ![device-panel-connected-android-dev-only-v22.png](http://ww3.sinaimg.in/large/006tNbRwgw1f6qwpougquj308c05rjro.jpg)
...
QRConference Buddy app在设备上的呈现
  ...
  ![qr-conf-debug1.png](http://ww2.sinaimg.in/large/006tNbRwgw1f6qws6ft9kj30j4076766.jpg)
...
![user-interface-ios2.png](http://ww4.sinaimg.in/large/006tNbRwgw1f6qwwh48svj30qd0ddn13.jpg)

![screencast1_v22.png](http://ww4.sinaimg.in/large/006tNbRwgw1f6qwwoklfdj30sb0e8gp5.jpg)
...
3. 当安装完成后设备面板上多出一条app提示
  ...
  ![app_installed_notice_v2.png](http://ww3.sinaimg.in/large/006tNbRwgw1f6qxgg77iaj30h80cidh6.jpg)
...
2. 将文件拖拽到设备面板上
  ...
  ![drag_and_drop_install_v2.png](http://ww4.sinaimg.in/large/006tNbRwgw1f6qxhmpincj30h80cjtak.jpg)
...
![general-settings-start-app.png](http://ww2.sinaimg.in/large/006tNbRwgw1f6qxj7zzgjj30g708t3zx.jpg)
...
2. 从菜单中单击要运行的app。菜单关闭后app将立即运行
  ...
  ![run-app-menu12.png](http://ww1.sinaimg.in/large/006tNbRwgw1f6qxkzk5l3j30dr085gm8.jpg)
...
![active_app_v21.png](http://ww1.sinaimg.in/large/006tNbRwgw1f6qxmh1iqtj30ms0cy77y.jpg)

当你选择第二个app调试时，一个新的选项卡打开。单击可以切换到另一个选项卡。两个选项卡是蓝色时因为他们同时打开的是一个调试实例。无论如何，当前使用的是高亮的，其他的是灰色的。

![multiple_active_apps2_v21.png](http://ww4.sinaimg.in/large/006tNbRwgw1f6qxnv2e47j30ms0cyaeu.jpg)

#### 设备视图截屏

点击Snapshot图标为设备视图截屏

![snapshot-pgdevapp1.png](http://ww2.sinaimg.in/large/006tNbRwgw1f6qxocxpoyj30hq0cc3zl.jpg)

从Settings设置你想如何操作截图

![snap-settings.png](http://ww4.sinaimg.in/large/006tNbRwgw1f6qxorltasj30gu098404.jpg)
...
![syslog-menu.png](http://ww1.sinaimg.in/large/006tNbRwgw1f6qxp6njjaj308b04oaa4.jpg)

从Settings中设置你想对日志的操作

![syslog-settings.png](http://ww1.sinaimg.in/large/006tNbRwgw1f6qxqlq4klj30go09etaf.jpg)
...
![syslog-clear-menu.png](http://ww4.sinaimg.in/large/006tNbRwgw1f6qxroha1xj305p04pq2y.jpg)

#### 重启和设备关机

![restart-shutdown-menu.png](http://ww2.sinaimg.in/large/006tNbRwgw1f6qxsm3vdzj308904owek.jpg)

...
### 什么是语义化的HTML?
根据页面需要选用合适的html标签，可以直观的通过代码认识标签的作用，对于搜索引擎的抓取有好处。
...
// Otherwise the array will have one element with x1 as its value. var a3 = new Array(x1); 
// Length is 0. var a4 = new Array;

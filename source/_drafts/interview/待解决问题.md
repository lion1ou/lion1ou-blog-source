...
1.从输入url到页面加载出来，发生了什么事情；
2.从域名到IP地址用了什么协议，从MAC地址到IP地址用什么协议；
3.ARP协议是什么
4.TCP链接过程
5.TCP为什么不能两次握手
6.TCP如何保证可靠传输的
...
9.ipv4与ipv6区别；
10.http端口，其他常用端口；
11.如果有缓存会发HTTP请求吗？缓存存在哪里，会清空吗？301，302，304；
12.设计一个支持缓存的网络协议，服务器如何判断缓存与服务器端数据是否不同。如何校验数据；
13.加密数据，md5如何破解，如何防止md5破解；
14.JS为什么放在最后；
15.多个JS文件加载顺序；
16.如何实现往ul里加多个li，一次append如何实现；
17.为每个li绑定事件，alert出元素；
18.如何实现ul中动态添加li也能为每个li绑定事件，（事件委托），为什么；
19.如何判断我点击的元素是li元素；
20.jsonp是什么，原理；
21.进程与线程区别；
22.自定义字体，为什么能提高性能。
...
1、多核CPU
2、进程和线程的区别、线程间通信
3、TCP和UDP的区别 具体应用场景 位于哪一层
4、get和post请求区别  传输大小为什么会有限制   post为什么会更安全
5、HTTP常见的状态码
6、遍历一个文件夹包括所有子文件、我说的递归、面试官要求不用递归
7、二分查找
8、快速排速的思想、时间复杂度
9、浏览器缓存
10、对于前端工程师的理解
11、学了什么框架 我说vue2.0,他说为什么vue2.0会出现
12、MVVM指的什么
14、继承vue组件
二面
1、聊项目（聊得很详细）
2、客户端和前端的区别
3、jsonp的具体实现原理，在封装的时候失败了怎么知道？
4、webpack遵循哪些规范，具体用来干写什么
6、es6的一些特点，以及如何兼容浏览器
5、vue.js里生命周期函数created和mounted的区别
6、nodejs如何起一个服务，以及维持服务不中断和express的一些大概使用
7、vue.js封装了什么组件，我说弹出框，问如何布局的，层级被别的覆盖了怎么办
8、如何比较项目的好坏，我说的优化、可维护性、可扩展性，然后面试官问我，怎么评价性能好坏，我说的有专门测试的网站的，然后面试官问具体的可维护性有哪些？
9、问我一个问题
刚刚电话面试完，现在等通知，积攒人品，让我能通过二面，悲催的我至今还没有任何offer

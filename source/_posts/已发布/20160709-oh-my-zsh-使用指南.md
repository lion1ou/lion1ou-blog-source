...
#安装下面的格式填写自己需要激活的插件
plugins=(autojump colored-man zsh_reload zsh-syntax-highlighting git git-flow ruby gem python pip node npm bower)
...
## 安装插件
在~/.oh-my-zsh/custom/plugins/中已经自带了很多插件，只是没有激活而已，我们可以根据上面的插件激活方式进行激活。

...
* 安装后执行`hexo deploy`，部署代码至Github
    ...
    >如出现帐号验证提示，请按照提示，分别输入自己的Github账号用户名和密码，开始提交。如需配置Github SHH验证，请参见[git学习](http://blog.lion1ou.tech/2016/09/11/)
...
* 域名申请，可以在阿里云注册，本人的[lion1ou.win](http://blog.lion1ou.tech)就是阿里云注册的，25RMB/五年，这里不赘述。
...
* 然后等待一会，再访问[lion1ou.win](http://blog.lion1ou.tech)，就ok了。
